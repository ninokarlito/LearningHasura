...
Gambar diatas menunjukkan Failed Transaction Rate (tingkat transaksi gagal) dalam observasi.
![image](https://github.com/user-attachments/assets/bd6c7880-69c6-40cb-86bc-c52e96ad5533)
Gambar menunjukkan grafik distribusi latensi transaksi. Grafik ini memberikan gambaran tentang berapa banyak transaksi yang terjadi pada rentang waktu latensi tertentu. Berikut adalah beberapa poin yang terlihat dari grafik tersebut:

1. **Total Transaksi:** Grafik mencatat 7,103 total transaksi.
2. **Distribusi Latensi:** Sebagian besar transaksi memiliki latensi antara 4 ms hingga 8 ms, dengan puncak frekuensi sekitar 5 ms.
3. **Persentil ke-95 (95p):** Ditandai pada grafik, ini menunjukkan latensi di mana 95% transaksi terjadi di bawah waktu tersebut.
4. **Ekor Distribusi:** Beberapa transaksi memiliki latensi yang lebih tinggi, hingga 200 ms, tetapi jumlahnya jauh lebih sedikit.
